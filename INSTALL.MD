 ...
 Dummyinstaller.sh checks if the depencies and golang are installed
 and installs them if necessary. Then it writes the needed environment
 variables to ~/.profile and downloads and compiles the brainwallet
 with all required depencies.
